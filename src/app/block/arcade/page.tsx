...
// Arcade sub-piece 1 games only (see docs/HANDOFF-18.md §1/§3). War, Chess,
// Mystery, Shooter, and the RPG aren't registered yet — adding their keys
// here before the games-registry row exists would just show "no scores
// yet" forever, which is confusing rather than honest. Add each key here
// in the same sub-piece session that seeds it in seed-games.ts.
    ...
    <main>
      ...
      <section style={{ padding: "0 2rem 3rem", maxWidth: "720px", display: "grid", gap: "2rem" }}>
        ...
        <p style={{ color: "var(--text-secondary)", fontSize: "0.9rem" }}>
          War, Chess, Mystery, Shooter, and the RPG aren't built yet — their
